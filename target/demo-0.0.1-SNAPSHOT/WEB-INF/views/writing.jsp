...
<!-- ------------------------------------------------------------ -->
    ...
    <!-- 👇 메인화면 전체 게시판 👇 -->
    <form action="frmwrite" method=POST enctype="multipart/form-data">
    <div class="Main-All-Board" style="float: left;">
        <table class="Main-All-Boardtable">
            <tr>
                <td class="Main-All-BoardName" colspan="2">
                    📝글쓰기📝
                </td>
            </tr>
            <tr class="Main-All-BoardTitle">
                <td id="MAB01_01">
                    ...
                    <c:if test="${UserDominame=='그리핀도르'}">
                        <select id="category">
                            <c:forEach var="ca" items="${cateGryList}">
                                <option value="${ca.category}">${ca.catename}</option>
                            </c:forEach>
                        </select>
                        <input type="hidden" id="catehidden" name="boardcategory" value="1">
                    </c:if>
                    <c:if test="${UserDominame=='슬리데린'}">
                        <select id="category">
                             <c:forEach var="ca" items="${cateSlyList}">
                                 <option value="${ca.category}">${ca.catename}</option>
                             </c:forEach>
                        </select>
                        <input type="hidden" id="catehidden" name="boardcategory" value="1">
                    ...
                    <c:if test="${UserDominame=='레번클로'}">
                         <select id="category">
                              <c:forEach var="ca" items="${cateRavList}">
                                  <option value="${ca.category}">${ca.catename}</option>
                              </c:forEach>
                         </select>
                         <input type="hidden" id="catehidden" name="boardcategory" value="1">
                    ...
                    <c:if test="${UserDominame=='후플푸프'}">
                         <select id="category">
                              <c:forEach var="ca" items="${cateHufList}">
                                   <option value="${ca.category}">${ca.catename}</option>
                              </c:forEach>
                         </select>
                         <input type="hidden" id="catehidden" name="boardcategory" value="1">
                    ...
                    <c:if test="${UserDominame=='교직원'}">
                         <select id="category">
                              <c:forEach var="ca" items="${cateTeaList}">
                                   <option value="${ca.category}">${ca.catename}</option>
                              </c:forEach>
                         </select>
                         <input type="hidden" id="catehidden" name="boardcategory" value="1">
                    ...
                    <input type="hidden" id="writer" name="writer" value="${userinfo.nick}">
                </td>
                <td id="MAB01_02">
                    <b>제목</b>
                    &nbsp;<input type="text" id="boardname" name="boardname" value="${boardinfo.boardname}" maxlength='15'>
                    <input type="submit" value="등록하기">
                </td>
            </tr>
            <tr class="Main-All-BoardTitle">
                <td id="MAB01_06" colspan="2">
                    <input type="file" name="file" value="${boardinfo.filename}">
                </td>
            </tr>
            <tr class="Main-All-Board-Contents">
                <td class="MAB02_01" colspan="2">
                    <textarea name="content" id="writing_box" cols="30">${boardinfo.content}</textarea>
                </td>
            </tr>
            <tr>
                <td class="Main-All-BoardBottom" colspan="2"></td>
            </tr>
        </table>
    </div>
    </form>
...
<script type="text/javascript">
    ...
    .on('click','#category',function(){
        c = $("#category option:selected").val();
        $("#catehidden").val(c);
    })
</script>
</html>