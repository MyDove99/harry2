            ...
            <table class="Main-All-Boardtable">
                ...
                <c:forEach var="a" items="${boardlist}">
                    <tr class="Main-All-Board-Contents">
                        ...
                        <td class="MAB02_02" style="cursor:pointer; text-align: left;"
                        onclick="location.href='read?boardnum=${a.boardnum}'">
                            ${a.boardname}
                        </td>
                        <td class="MAB02_03" style="cursor:pointer;"
                        onclick="location.href='userinfo?usernum=${a.usernum}&nick=${a.writer}'">
                            ${a.writer}
                        </td>
                        <td class="MAB02_04">
                            <c:set var="TextValue" value="${a.writedate}"/>
...
<!-- 👇 메인화면 채팅창 👇 -->
    <div class="Main-Chat-Div" style="float: left;">
    ...
    <!-- 👇 메인화면 기숙사 랭킹 👇 -->
    <div class="Main-DomitoryRank-Div" style="float: bottom;">
...
<c:set var="rank" value="0"/>
    ...
    <div class="Main-Game-Div" >
        <table class="Main-Game-Table">
            <tr>
                <td  class="Main-Game-Top-td" colspan="2">
                    🎃🎮호그와트 오락실🎮🎃
                </td>
            </tr>
            <tr class="Main-Game-Mid">
                <td class="Main-Game-Contents">
                    <a href="arcadegate" class="Arcade"><img src="/css/main/Arcade.png"></a>
                </td>
            </tr>
            <tr>
                <td class="Main-Game-Bottom-td" colspan="2"></td>
            </tr>
        </table>
    </div>

    <!-- 👇 메인화면 앨범 👇 -->
        <div class="Main-Album-Div">
            <table class="Main-Album-Table">
            <tr>
                <td class="Main-Album-Top">🧙‍♂️호그와트 앨범🧙‍♀️</td>
            </tr>
            <tr>
            <td class="Main-Album-Mid">
                <div>
                    <ul class="Main-Album" id="imgboard">
                    <c:forEach var="al" items="${albumlist}">
                        <li style="float: left; margin-left: 16px;" id="first-Photo">
                            <dl>
                                <dt>
                                    <a href="read?boardnum=${al.boardnum}">
                                        <img src="/files/${al.filename}" class="Album-Photo">
                                    </a>
                                </dt>
                                <dd>
                                    <a href="read?boardnum=${al.boardnum}" class="Album-Title">
                                        <c:set var="TextValue" value="${al.boardname}"/>
                                        ${fn:substring(TextValue,0,8)}
                                    </a>
                                </dd>
                                <dd>
                                    <a id="btn" style="cursor:pointer;"
                                    onclick="location.href='userinfo?usernum=${al.usernum}&nick=${al.writer}'">
                                        ${al.writer}
                                    </a>
                                </dd>
                            </dl>
...
<script type="text/javascript">
	...
	function popup(){
                    var url = "find";
                    var name = "popup test";
                    var option = "width = 460, height = 280, top = 100, left = 200, location = no"
