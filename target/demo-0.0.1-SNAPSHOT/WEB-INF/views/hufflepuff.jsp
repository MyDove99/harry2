...
<head>
    ...
    <!-- ▼CSS 연결▼ -->
    <link rel="stylesheet" href="/css/domitory/hufflepuff.css">
...
<div class="Explanation-Div">
    <table class="Explanation-Table">
        <tr class="Explanation-Top-tr">
            <td class="Explanation-td">Hufflepuff House Story</td>
        </tr>
        <tr>
            <td id="Explanation">
                <div id="Explanation-Div2">
                    "<span id="Explanation-color">성실하고 진실된 자들을 위한 기숙사</span>"<br>
                    정의로운 일이라면 고민도 하지 않고 옳은 일을 하려는 멋진 이념을 가진 기숙사.<br>
                    현재 기숙사 사감은 포모나 스프라우트.<br>
                    슬리데린 기숙사를 상징하는 원소는 흙.<br>
                    기숙사 대표 특성은 헌신, 협동, 인내, 친절, 관용이다.<br>
                    슬리데린 기숙사의 유령은 뚱보 수도사,<br>
                    기숙사의 입구는 후플푸프 지하실에 있다.<br><br>
                    기숙사 모토를 봤을 때 성실하고 진실한 자들이 가는 기숙사이다.<br>
                    창립 이념부터가 차별 없이 학생들이 원하는 것을 이루어주도록 지지하는 기숙사,<br>
                    문장 그대로 '좋은 기숙사'다.<br>
                    조화롭고 사건 사고가 일어날 날 없이 평화로운 성향 때문인지<br>
                    매니아층은 다른 기숙사에 비해 적지만 그 매니아들의 사랑은<br>
                    말로 표현할 수 없을 정도로 깊다.<br><br>
                    특이한 점은, 기숙사 중 유일하게 기숙사 입장 암호를 틀렸을 때<br>
                    함정이 발동되는 기숙사이기도 하다.<br>
                    배럴 통을 후플푸프를 읽을 때의 음절과 박자 그대로 두드려야<br>
                    기숙사로 들어오는 길이 열리는데, 만약 틀리면<br>
                    식초나 포도주가 튀어나와 침입자를 적신다고 한다.<br><br>
                    다만, 그리핀도르나 슬리데린은 암호가 자주 변경되고,<br>
                    래번클로는 아예 지능 테스트를 하는데 반해 후플푸프는 암호가 바뀌지 않는다.<br><br>
                    어둠의 마법사가 가장 적은 기숙사와 동시에 훌륭한 마법 정부 총리는<br>
                    후플푸프 출신이 가장 많다.<br>
                    어느 기숙사에서나 어둠의 마법사는 존재하는데,<br>
                    인원이 가장 많은 기숙사인 후플푸프가 어둠의 마법사 배출이 가장 적은 것을 보면<br>
                    확실히 좋은 기숙사는 맞다.<br><br>
                    후플푸프의 특징이 '착함'이라는 이미지에 가려 별 다른 특징이 없다고<br>
                    오해하는 사람들이 많다고 하지만 정직하고 바른 성품과 사랑이 넘치는 특징이<br>
                    모든 특징 중 가장 두드러지기 때문이지 평범한 사람이 배정되는 곳은 아니다.<br>
                    성공하거나 이름이 널리 알려진 마법사들을 보면 대인배성과 상장형이 겹친<br>
                    착하고 정의로운 주인공형이 높다.<br><br>
                    볼드모트, 어둠의 기숙사와 호그와트의 결투에서 그리핀도르 다음으로<br>
                    많은 학생들이 결투에 참가했는데, 싸움에 가담한 이유는<br>
                    그리핀도르는 자신들의 영광, 래번클로는 손해와 이익,<br>
                    슬리데린은 자신들의 야심 등이었던 반면,<br>
                    후플푸프는 오직 그것이 옳은 일이기 때문 뿐이었다.<br><br>
                    작 중에서도 후플푸프의 설정은 진정한 정의로운 기숙사라는 컨셉이다.<br>
                    작 중 세계관에서 훗날 해리포터의 자식 세대인 에드워드 리머스 루핀이<br>
                    호그와트 학생회장 자리를 맡으면서<br>
                    후플푸프가 영광을 누리는 계기가 된다.
                </div>
            </td>
        </tr>
    </table>
...
<div class="Explanation-Div2">
    <table class="Explanation-Table2">
        ...
        <tr id="Explanation">
            <td id="Explanation2">
                <span id="yello">노란색</span>, <span id="black">검은색</span>
            </td>
            <td id="Explanation3">
                오소리
            </td>
...
<div class="Main-All-Board" style="float: left;">
    <table class="Main-All-Boardtable">
        ...
        <c:forEach var="h" items="${hufList}">
            <tr class="Main-All-Board-Contents">
                <td class="MAB02_01">
                    <c:set var="TextValue" value="${h.writedate}"/>
                    ${fn:substring(TextValue,0,10)}
                </td>
                <td class="MAB02_02" style="text-align: left; cursor:pointer;" onclick="location.href='read?boardnum=${h.boardnum}'">
                    ${h.boardname}
                </td>
                <td class="MAB02_03" style="cursor:pointer;"
                onclick="location.href='userinfo?usernum=${h.usernum}&nick=${h.writer}'">
                    ${h.writer}
                </td>
                <td class="MAB02_04">
                    ${h.views}
