...
<div class="Main-All-Board" style="float: left;">
    <table class="Main-All-Boardtable">
        ...
        <tbody id="tbody">
        <c:forEach var="fr" items="${allList}">
        <c:set var="b" value="1"/>
        <c:if test="${b==fr.paging}">
            <tr class="Main-All-Board-Contents">
                <td class="MAB02_01">
                    ${fr.catename}
                </td>
                <td class="MAB02_02" style="text-align: left; cursor:pointer;" onclick="location.href='read?boardnum=${fr.boardnum}'">
                    ${fr.boardname}
                </td>
                <td class="MAB02_03"  style="cursor:pointer;"
                onclick="location.href='userinfo?usernum=${fr.usernum}&nick=${fr.writer}'">
                    ${fr.writer}
                </td>
                <td class="MAB02_04">
                    <c:set var="TextValue" value="${fr.writedate}"/>
            ...
            <input type="hidden" id="category" value="${fr.category}">
        </c:if>
        </c:forEach>
        </tbody>
        <tr>
...
<center>
<div class="paging">
    <c:forEach var="i" begin="1" end="${maxpaging}">
        <span class="page" id="pagez${i}" style=" cursor:pointer;">${i}</span>
    </c:forEach>
</div>
</center>
</body>
