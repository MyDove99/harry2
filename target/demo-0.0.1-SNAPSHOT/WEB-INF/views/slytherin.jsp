...
<head>
    ...
    <!-- ▼CSS 연결▼ -->
    <link rel="stylesheet" href="/css/domitory/slytherin.css">
...
<div class="Explanation-Div">
    <table class="Explanation-Table">
        <tr class="Explanation-Top-tr">
            <td class="Explanation-td">Slytherin House Story</td>
        </tr>
        <tr>
            <td id="Explanation">
                <div id="Explanation-Div2">
                    "<span id="Explanation-color">재간꾼들을 위한 기숙사</span>"<br>
                    창립자의 영향으로 순수혈통주의자의 비율이 높다.<br>
                    현재 기숙사 사감은 호러스 슬러그혼.<br>
                    슬리데린 기숙사를 상징하는 원소는 물.<br>
                    기숙사 대표 특성은 지략, 야망, 교활, 결단력, 긍지, 형제애다.<br>
                    슬리데린 기숙사의 유령은 피투성이 남작,<br>
                    기숙사의 입구는 지하감옥 벽에 있다.<br><br>
                    죽음을 먹는 자들의 상당 수가 슬리데린 출신이다.<br>
                    그리핀도르와는 사이가 나쁜 라이벌 관계이며, 재미있는 점은<br>
                    그리핀도르는 죽음을 먹는 자들과 대립하는 오러를 가장 많이 배출했지만,<br>
                    슬리데린 다음으로 어둠의 마법사를 가장 많이 배출한 기숙사라는 점이다.<br>
                    어둠의 마법사가 가장 적은 기숙사는 후플푸프 기숙사.<br><br>
                    슬리데린에 속한 이들은 자신의 능력이 인정받기를 원하는 경향이있다.<br>
                    그런 탓인지 권력을 추구하는 인물이 많은 편이기도 하다.<br>
                    물론 권력을 추구한다는 것이 나쁜 것은 아니지만<br>
                    호그와트 졸업 후에 죽음을 먹는 자가 되거나, 그게 아니더라도<br>
                    나쁜 쪽으로 수단과 방법을 가리지 않는 이들이 많은 기숙사다.<br>
                    유독 악인들이 많이 배출되는 기숙사기 때문에 평판이 좋지 않다.<br>
                    다른 기숙사에서 그리핀도르 기숙사의 평판이 좋지 않지만,<br>
                    그리핀도르가 7년 만에 슬리데린의 우승 독주를 저지하고<br>
                    기숙사 우승컵을 탈환하자, 다른 기숙사인 래번클로와 후플푸프에서<br>
                    축하를 해줬을 정도로 슬리데린의 평판은 좋지 않다.<br>
                    작 중에서도 슬리데린을 막기 위해 그리핀도르, 후플푸프, 래번클로가<br>
                    모두 일어나서 슬리데린에게 지팡이를 겨눴으니 이 정도면 왕따 수준이다.<br>
                    호그와트의 가장 큰 축제 중 하나인 기숙사간의 퀴디치 리그 결승전에서<br>
                    래번클로와 후플푸프도 그리핀도르의 상징이 들어간 장식물이나 응원도구를 흔들며<br>
                    그리핀도르를 열심히 응원하는 모습이 나온다.<br><br>
                    하지만 호그와트 내에서 따돌림을 당할 뿐, 슬리데린 출신들이<br>
                    영국 마법사 사회를 좌지우지하는 순수 혈통의 상당 수를 차지하고있다.<br>
                    순수 혈통 우대법이 존재 할 정도로 순수혈통들의 권력은 거대하다.<br>
                    다만, 킹슬리가 순수혈통 우대법을 폐지하고 위즐리 가문을 앞 세운<br>
                    그리핀도르 출신들이 마법부의 중요한 자리를 맡게 되어<br>
                    현재는 순수혈통들의 위세가 한참 줄어든 상황이다.<br><br>
                    슬리데린 출신이라고 해서 모두 나쁜 사람들만 있는 것이 아니며,<br>
                    순혈주의자만 있는 것도 아니다.<br>
                    일부 슬리데린 학생들은 다른 기숙사 학생들과 서로의 등을 기대며<br>
                    죽음을 먹는 자들과 맞써 싸웠다.<br>
                </div>
            </td>
        </tr>
    </table>
...
<div class="Explanation-Div2">
    <table class="Explanation-Table2">
        ...
        <tr id="Explanation">
            <td id="Explanation2">
                <span id="green">녹색</span>, <span id="silver">은색</span>
            </td>
            <td id="Explanation3">
                뱀
            </td>
...
<div class="Main-All-Board" style="float: left;">
    <table class="Main-All-Boardtable">
        ...
        <c:forEach var="s" items="${slyList}">
            <tr class="Main-All-Board-Contents">
                <td class="MAB02_01">
                    <c:set var="TextValue" value="${s.writedate}"/>
                    ${fn:substring(TextValue,0,10)}
                </td>
                <td class="MAB02_02" style="text-align: left; cursor:pointer;" onclick="location.href='read?boardnum=${s.boardnum}'">
                    ${s.boardname}
                </td>
                <td class="MAB02_03" style="cursor:pointer;"
                onclick="location.href='userinfo?usernum=${s.usernum}&nick=${s.writer}'">
                    ${s.writer}
                </td>
                <td class="MAB02_04">
                    ${s.views}
