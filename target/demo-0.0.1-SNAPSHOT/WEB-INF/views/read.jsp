...
<!-- ------------------------------------------------------------ -->
    ...
    <div class="Main-All-Board" style="float: left;">
            ...
            <!-- 👇 글 작성자 👇 -->
            <c:if test="${userinfo.nick==boardinfo.writer}">
            ...
            <tr class="Main-All-BoardTitle">
                ...
                <td id="MAB03_02" colspan="2">
                제목: ${boardinfo.boardname}
                </td>
                <td id="MAB03_03">
                    <input type="button" onclick="location.href='update?boardnum=${boardinfo.boardnum}'" value="수정하기">
                    <input type="button" value="삭제하기" onclick="location.href='delete?boardnum=${boardinfo.boardnum}'">
                </td>
                </tr>
                <tr class="Main-All-Board-Contents">
                <td class="MAB02_01" colspan="4">
                    <div id="read_box" align="left">
                       <img src="/files/${boardinfo.filename}" onerror="this.src='/files/replaced.jpg'" style="width:200px; height:200px;">
                       <p class="contentP" style="color:white; margin-top:30px;">${boardinfo.content}</p>
                    </div>
                </td>
            </tr>
            <tr>
                <td id="MAB01_05_2" colspan="4">
                    작성시간: ${boardinfo.writedate} / <span id="commentcount">댓글: ${commentcount}</span> / 조회: ${boardinfo.views} / <span id="liked">추천: ${liked} </span>
                </td>
            </tr>
            <tr>
                <td id="Read-Comment" colspan="3">
                    <textarea id="Comment" maxlength="300" placeholder="최대 300자 입력가능" spellcheck="false"></textarea>
                </td>
                <td id="Comment_send">
                    <input type="button" id="sendbtn" value="등록">
                </td>
            </tr>
            </c:if>
            ...
            <!-- 👇 글 작성자 아닐 때 👇 -->
            <c:if test="${userinfo.nick!=boardinfo.writer}">
            <table class="Main-All-Boardtable2">
            <tr>
            <td class="Main-All-BoardName" colspan="4">
            ...
            <tr class="dumdum">
                <td id="MAB01_05" colspan="2">
                    작성시간: ${boardinfo.writedate} / <span id="commentcount">댓글: ${commentcount}</span>
                    <span id="good"><input type="button" id="btnlike" value="👍추천하기👍"></span>
                </td>
                <td id="MAB01_07" colspan="2">
                    작성자: ${boardinfo.writer}
                </td>
            </tr>
        ...
        <div class="Comment-div">
            <table class="Comment-list" id="commenttable">
            <tr>
                <td id="Read-Comment-title" colspan="2">
                <b>[COMMENT]</b>
                </td>
            </tr>
                <tfoot id="tfoot">
                    <c:set var="b" value="0"/>
                        <c:forEach var="a" items="${comments}">
                            <c:if test="${b==a.cdepth}">
                                <tr>
                                    <td id="list-nick" colspan="2">
                                        ${a.writer} · ${a.writedate}
                                    </td>
                                </tr>
                                <tr>
                                    <td id="list-contents" colspan="2">
                                        ${a.content}
                                    </td>
                                </tr>
                                <tr>
                                    <td id="답글" colspan="2" style="text-align:left;">
                                        <input type="button" id="tocommentz${a.comgroup}" style="cursor:pointer;" class="tocomment" value="답글">
                                    <c:if test="${a.writer == userinfo.nick}">
                                        <c:set var="yn" value="n" />
                                        <c:if test="${a.deleteyn == yn}">
                                            <input type="button" id="deletez${a.comnum}" style="cursor:pointer; background-color:red;" class="commentdel" value="삭제">
                                        </c:if>
                                    </c:if>
                                    </td>
                                </tr>
                            ...
                            <c:if test="${b!=a.cdepth}">
                                <tr class="recom-nick">
                                    <td id="recom-nick" colspan="2">
                                        └ ${a.writer} · ${a.writedate}
                                    </td>
                                </tr>
                                <tr class="recom-con">
                                    <td id="recom-con">
                                        &nbsp&nbsp&nbsp&nbsp${a.content}
                                    </td>
                                    <c:if test="${a.writer == userinfo.nick}">
                                        <td>
                                            <input type="button" id="todeletez${a.comnum}" style="cursor:pointer; background-color:red;" class="commentdel" value="삭제">
                                        </td>
                                    </c:if>
                                </tr>
                            </c:if>
    ...
    <%-- 추가 내용 --%>
    <input id="boardnum" type="hidden" value="${boardinfo.boardnum}">
    <input type="hidden" name="userName" id="userName" value="${userinfo.nick}">
</body>
<script src="https://code.jquery.com/jquery-3.5.1.js"></script>
