...
<body>
    ...
    <div class="write mx-auto">
        ...
        <table class="signTable mx-auto">
            <tr>
                <td>이름</td>
                <td><input type="text" class="name form-control" placeholder="NAME" name="name" value="${name}"></td>
            </tr>
            <tr><td>아이디</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="email" class="email form-control" placeholder="E-mail" name="email" value="${email}">
            </tr>
            <tr>
                <td>모바일</td>
