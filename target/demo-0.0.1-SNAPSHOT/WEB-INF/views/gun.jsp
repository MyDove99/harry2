...
<head>
    ...
    <!-- ▼파비콘▼ -->
    <link rel="shortcut icon" href="/css/그레이트홀/icons9.png">
...
<div class="Main-All-Board" style="float: left;">
    <table class="Main-All-Boardtable">
        ...
        <c:forEach var="gun" items="${gunList}">
            <tr class="Main-All-Board-Contents">
                <td class="MAB02_01">
                    ${gun.catename}
                </td>
                <td class="MAB02_02" style="text-align: left; cursor:pointer;" onclick="location.href='read?boardnum=${gun.boardnum}'">
                    ${gun.boardname}
                </td>
                <td class="MAB02_03" style="cursor:pointer;"
                onclick="location.href='userinfo?usernum=${gun.usernum}&nick=${gun.writer}'">
                    ${gun.writer}
                </td>
                <td class="MAB02_04">
                    <c:set var="TextValue" value="${gun.writedate}"/>
