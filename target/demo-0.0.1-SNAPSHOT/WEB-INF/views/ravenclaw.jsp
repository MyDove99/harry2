...
<head>
    ...
    <!-- ▼CSS 연결▼ -->
    <link rel="stylesheet" href="/css/domitory/ravenclaw.css">
...
<div class="Explanation-Div">
    <table class="Explanation-Table">
        <tr class="Explanation-Top-tr">
            <td class="Explanation-td">Ravenclaw House Story</td>
        </tr>
        <tr>
            <td id="Explanation">
                <div id="Explanation-Div2">
                    "<span id="Explanation-color">현명하고 사려 깊은 자들을 위한 기숙사</span>"<br>
                    자신들의 괴짜같은 모습마저 스스로 존중하는 자긍심 넘치는 기숙사.<br>
                    현재 기숙사 사감은 필리우스 플리트윅.<br>
                    래번클로 기숙사를 상징하는 원소는 공기.<br>
                    기숙사 대표 특성은 지혜, 지식, 지능, 창의성, 개성이다.<br>
                    래번클로 기숙사의 유령은 회색 여인,<br>
                    기숙사의 입구는 청동 독수리상 뒤에 있다.<br><br>
                    창립자의 이념에 따라 지혜와 지식, 그리고 재치를 중요하게 여긴다.<br>
                    지혜로운 학생을 위한 기숙사가 창립 이념이지만 소속 인물들을 살펴보면<br>
                    흔히 생각하는 품행이 바른 모범생과는 거리가 먼 인물들이 많다.<br>
                    당장 작 중에서 알려진 성적우수자만 해도 다른 기숙사에 비해 가장 적다.<br>
                    래번클로의 '지혜'에는 단순히 공부만 잘하는 것이 아닌 창의성, 독창성도 포함되어있다.<br>
                    이 때문에 괴짜들이 많고 래번클로에서만 통하는 유머도 존재하는데,<br>
                    그 농담을 만든 사람들의 대부분이 그리핀도르 출신 사람들이라는 농담도 있다.<br><br>
                    많은 사람들이 신경 쓰지 않는 사실이지만<br>
                    래번클로는 무언가에 참여하거나 관여되는 것을 가장 싫어하는<br>
                    개인주의 성향이 높은 기숙사이다.<br>
                    그렇기 때문에 불사조기사단, 죽음을 먹는 자들 등 어디에도 깊게 관여하지 않는다.<br><br>
                    다른 기숙사는 기숙사에 들어가기 위해 암호를 말하는 것과 달리,<br>
                    래번클로에서는 암호가 따로 정해져있지 않다.<br>
                    대신 기숙사에 들어가기 위해 청동 독수리상이 내는 문제를 맞추어야 하며,<br>
                    문제를 맞힐 수만 있다면 래번클로 소속이 아니더라도 출입이 가능하다.<br>
                    답이 정해진 지식만을 요구하는 문제가 아니라<br>
                    지혜와 재치를 요구하는 문제를 내는 것으로 추정된다. 흔히 말하는 넌센스.<br>
                    이 때문에 래번클로 기숙사 입구에는 항상 학생들이 모여서<br>
                    독수리상이 내는 문제에 대한 해답을 찾기 위해 의논하는 풍경이 벌어진다.<br>
                    수업 준비물을 깜빡 잊고 와서 급하게 다시 가지러 가야하는 상황이 오면<br>
                    큰일이 벌어지는 귀찮은 시스템이며,<br>
                    그렇기 때문에 포터모어의 래번클로 환영인사에서는<br>
                    수업에 가기 전 준비물을 꼭 대여섯 번 확인하고 나가라는 주의 문구가 존재한다.<br><br>
                    작 중에서 비중이 없는 기숙사 중 하나지만 대표적으로 루나 러브굿이라는<br>
                    비중 높고 매력있는 등장 인물 덕분에 존재감이 높은 편이며,<br>
                    대부분의 학생들의 전투력은 현저히 낮다.<br>
                    실제로 작 중에서 호그와트에서 벌어진 볼드모트와의 결투에서 박살이 났다.
                </div>
            </td>
        </tr>
    </table>
...
<div class="Explanation-Div2">
    <table class="Explanation-Table2">
        ...
        <tr id="Explanation">
            <td id="Explanation2">
                <span id="blue">파란색</span>, <span id="bluegreen">청동색</span>
            </td>
            <td id="Explanation3">
                독수리
            </td>
...
<div class="Main-All-Board" style="float: left;">
    <table class="Main-All-Boardtable">
        ...
        <c:forEach var="r" items="${ravList}">
            <tr class="Main-All-Board-Contents">
                <td class="MAB02_01">
                    <c:set var="TextValue" value="${r.writedate}"/>
                    ${fn:substring(TextValue,0,10)}
                </td>
                <td class="MAB02_02" style="text-align: left; cursor:pointer;" onclick="location.href='read?boardnum=${r.boardnum}'">
                    ${r.boardname}
                </td>
                <td class="MAB02_03" style="cursor:pointer;"
                onclick="location.href='userinfo?usernum=${r.usernum}&nick=${r.writer}'">
                    ${r.writer}
                </td>
                <td class="MAB02_04">
                    ${r.views}
