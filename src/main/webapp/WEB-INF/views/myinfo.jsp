...
<div class="Main-All-Board" style="float: left;">
    ...
    <table class="Main-All-Boardtable">
        ...
        <tr class="Main-All-Board-Contents">
            <td class="MAB02_01" style="text-align: center;">
                이름
            </td>
            <td class="MAB02_02" style="text-align: center;">
                <input type="text" class="info" spellcheck="false" readonly name="username" value="${user.username}">
            </td>
            <td></td>
        </tr>
        <tr class="Main-All-Board-Contents">
            ...
            <td class="MAB02_02" style="text-align: center;">
                <input type="text" class="info" spellcheck="false" readonly name="userid" value="${user.userid}">
            </td>
            <td></td>
        </tr>
        <tr class="Main-All-Board-Contents">
            ...
            <td class="MAB02_02" style="text-align: center;">
                <input type="text" class="info" spellcheck="false" name="pwd" value="${user.pwd}">
            </td>
            <td></td>
        </tr>
        <tr class="Main-All-Board-Contents">
            ...
            <td class="MAB02_02" style="text-align: center;">
                <input type="text" class="info" spellcheck="false" maxlength="5" name="nick" id="usernick" value="${user.nick}">
                <br><span id="olmessage2"></span>
            </td>
            <td><input type="button" id="overlappedNick" value="중복확인"></td>
        </tr>
        <tr class="Main-All-Board-Contents">
            <td class="MAB02_01">
                모바일
            ...
            <td class="MAB02_02" style="text-align: center;">
                <input type="text" class="info" spellcheck="false" name="mobile" value="${user.mobile}">
            </td>
            <td></td>
        </tr>
        <tr class="Main-All-Board-Contents">
            ...
            <td class="MAB02_02" style="text-align: center;">
                <input type="text" class="info" spellcheck="false" name="email" value="${user.email}">
        ...
        <tr class="Main-All-Board-Contents">
            <td class="MAB02_01" colspan="2">
                <input type="submit" id="frmAddnew" value="수정완료"> <c:if test="${kakaocheck eq 1}">
                                                                                          <a href="javascript:secession();" class="logout"><input type="button" value="자퇴하기"></a>
                                                                                      </c:if>
                                                                                      <c:if test="${kakaocheck eq 0}">
                                                                                          <input type="button" value="자퇴하기" onclick="location.href='deleteuser?usernum=${user.usernum}'">
                                                                                      </c:if>
    ...
    <input type="hidden" name="memo" value="${user.nick}">
    </form>
</div>
</body>
