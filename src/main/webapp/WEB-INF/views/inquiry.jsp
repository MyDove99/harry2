...
<head>
    ...
    <!-- ▼파비콘▼ -->
    <link rel="shortcut icon" href="/css/그레이트홀/icons8.png">
...
<div class="Main-All-Board" style="float: left;">
    <table class="Main-All-Boardtable">
        ...
        <c:forEach var="in" items="${inquiryList}">
            <tr class="Main-All-Board-Contents">
                <td class="MAB02_01">
                    ${in.catename}
                </td>
                <td class="MAB02_02" style="text-align: left; cursor:pointer;" onclick="location.href='read?boardnum=${in.boardnum}'">
                    ${in.boardname}
                </td>
                <td class="MAB02_03" style="cursor:pointer;"
                onclick="location.href='userinfo?usernum=${in.usernum}&nick=${in.writer}'">
                    ${in.writer}
                </td>
                <td class="MAB02_04">
                    <c:set var="TextValue" value="${in.writedate}"/>
