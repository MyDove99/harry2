...
<head>
    ...
    <link rel="stylesheet" href="/css/textrpg/textrpg.css" type="text/css">
    <script src="https://code.jquery.com/jquery-3.5.1.js"></script>
    <title>금지된 숲</title>
</head>
<c:if test="${userinfo.dominum==0}">
            <body style="background-image: url('https://blog.kakaocdn.net/dn/re42Z/btrGvnNDEUd/DYnjeuBRrKD4jIMkzbG43k/img.gif');">
        </c:if>
        <c:if test="${userinfo.dominum==1}">
            <body style="background-image: url('https://blog.kakaocdn.net/dn/2HPDS/btrGuTF1Y8N/654FXloDhRhXrMcq0VhVAk/img.gif');">
        </c:if>
        <c:if test="${userinfo.dominum==2}">
            <body style="background-image: url('https://blog.kakaocdn.net/dn/cFQ7Xh/btrGv5eSDeX/dQ3AL2sJLrgGTUP0tKIhE1/img.gif');">
        </c:if>
        <c:if test="${userinfo.dominum==3}">
            <body style="background-image: url('https://blog.kakaocdn.net/dn/dTQHK7/btrGuSUD1bk/eIO4fqk8fjrKURGABv1pfk/img.gif');">
</c:if>
    ...
    <div class="banner">
        <c:if test="${userinfo.dominum==0}">
            <a href="main"><img src="https://blog.kakaocdn.net/dn/sIJZY/btrGtLVX8uH/M2APN55WAzYfAapSj6IVE1/img.gif"
            style="height: 200px;"></a>
        </c:if>
        <c:if test="${userinfo.dominum==1}">
            <a href="main"><img src="https://blog.kakaocdn.net/dn/djBIJ4/btrGq1SyLW1/cUCTofvRTzqbWSWJJ2Alik/img.gif"
            style="height: 200px;"></a>
        </c:if>
        <c:if test="${userinfo.dominum==2}">
        ...
        <c:if test="${userinfo.dominum==3}">
            <a href="main"><img src="https://blog.kakaocdn.net/dn/dQ8eAN/btrGt1EezbH/imj0u12B5KkOHRDPmvGpHk/img.gif"
            style="height: 200px;"></a>
        </c:if>
    </div>
    <div class="gamecenter" id="gamecenter">
        <div class="ingametext1">
            ...
            <div class="enemyimgdiv">
                <img src="/css/textrpg/owl.png" class="enemyimg" id="enemyimg">
            </div>
        </div>
        <hr>
    ...
    <div class="userinfo1">
        <table class="tableuserinfo">
            <tr>
                <td colspan="2" style="border: 2px solid white;">${userinfo.nick}님의 상태</td>
            </tr>
            <tr>
    ...
    <div class="userinfo3">
        <table class="tableuserinfo">
            ...
            <hr>
            <tr>
                <td>본인</td><td id="nick">${userinfo.nick}</td><td>${rank.score}점</td><td>${rank.stage}</td><td>${rank.boss}마리</td>
                <input type="hidden" id="dominum" value=${userinfo.dominum}>
            </tr>
        </table>
    </div>
</body>
<script type="text/javascript" src="/js/textrpg/textrpg.js"></script>
</html>