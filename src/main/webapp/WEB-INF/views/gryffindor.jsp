...
<head>
    ...
    <!-- ▼CSS 연결▼ -->
    <link rel="stylesheet" href="/css/domitory/gryffindor.css">
    ...
    <!-- ▼파비콘▼ -->
    <link rel="shortcut icon" href="/css/domitory/castle.png">

    <title>그리핀도르 기숙사 🕍</title>
</head>
<body>
    <!-- 👇 상단바 👇 -->
...
<!-- 👇 사이드바 로그인 후 👇 -->
    ...
    <div class="Explanation-Div">
        <table class="Explanation-Table">
            <tr class="Explanation-Top-tr">
                <td class="Explanation-td">Gryffindor House Story</td>
            </tr>
            <tr>
                <td id="Explanation">
                    <div id="Explanation-Div2">
                    "<span id="Explanation-color">용감하고 대담한 자를 위한 기숙사</span>"<br>
                    마법 세계의 우수한 마법사를 다수 배출했으며,<br>현재 기숙사 사감은 미네르바 맥고나걸.<br>
                    그리핀도르 기숙사를 상징하는 원소는 불.<br>기숙사 대표 특성은 용기, 대담함, 결단력, 기사도정신이다.<br>
                    그리핀도르 기숙사의 유령은 목이 달랑달랑한 닉,<br>기숙사의 입구는 뚱뚱한 귀부인 초상화 앞이다.<br>
                    그리핀도르 기숙사는 동쪽 탑에 위치해있다.<br><br>
                    세계관 최고의 마법사인 알버스 덤블도어를 배출해 낸 기숙사로 인식이 좋다.<br>
                    하지만 그리핀도르의 덕목인 용기가 긍정적인 일에만 해당하는 것은 절대 아니다.<br>
                    그리핀도르 특유의 사람에 대한 배려 없는 용기는 그저 눈살 찌푸려지는 만용이거나 자만심일 뿐이며,
                    생각 없이 일을 저지르고 보는 면이 있는 인물들도 많다.<br>
                    학교 폭력을 일삼던 제임스 포터, 한때는 권력 욕심에 찌들었던 퍼시 위즐리 등이<br>
                    좋은 예시로 볼 수 있다. 또한 신비한 동물들과 그린델왈드의 범죄에서는 <br>레타 레스트레인지를
                    내내 따돌리고 뒷담화한 여학생도 그리핀도르 소속이었고,<br>
                    호그와트 미스테리의 메인 빌런이자 보물을 찾기 위해 학생도 죽이고 다니는<br>
                    파트리샤 레이크픽도 그리핀도르 소속이다.<br>
                    슬리데린이라고 무조건 악역이 아니듯<br>그리핀도르라고 해서 무조건 착한 인물들은
                    아닌 셈이다.<br>그리핀도르는 애초에 용기 자체만 중요시하는 기숙사일 뿐,<br>그 용기의
                    방향성을 따지는 기숙사가 아니다.<br>
                    그리핀도르는 명예와 영광을 좇는 경향이 많아서 오러를 가장 많이 배출했지만,<br>
                    어둠의 마법사들 또한 슬리데린 다음으로 많이 배출한 기숙사다.<br>
                    현실에서도 수많은 역사가 증명하듯 용기가 만용으로 변질되거나<br>
                    근거 없는 긍정성을 가지면 오히려 용기 없는 경우보다도<br>
                    사회적으로 엄청난 해악을 가져온다.<br>
                    아니, 대놓고 알버스 덤블도어도 명예와 영광에 미쳐<br>사상 최강의 어둠의 마법사가 될 뻔했다.<br><br>
                    슬리데린과는 대척점에 있는 것 같지만,<br>
                    그리핀도르가 대의를 위해서 규칙을 과감히 어기는 모습을 보면,<br>
                    의외로 출세하기 위해 수단과 방법을 가리지 않는 슬리데린과 공통된 부분이 많다.
                    해리가 슬리데린을 거부하자 분류 모자가 대안으로<br>
                    그리핀도르로 보낸 것도 나름대로 이유가 있는 셈.
                    <br>주인공이 있는 기숙사라 좋게 보이는 거지, 학교 입장에서는<br>
                    사건을 해결하긴 해도 입학부터 졸업할 때까지 뒤에서 남몰래 사고 치는<br>
                    주인공 3인방이 마냥 좋게 보이지만은 않을 것이며,<br>
                    해리포터 작중 몇몇 교수들에게 그런 점을 자주 지적받는다.<br>
                    래번클로와는 은근히 반대 성향을 갖고 있는데,<br>
                    슬리데린과 후플푸프의 경우, 자신이 확실한 쪽에 참여 비중이 크고,<br>
                    래번클로의 경우 무언가 참여하는 걸 굉장히 싫어하는 데 비해<br>
                    그리핀도르는 불사조 기사단, 죽음을 먹는 자의 참여율이<br>
                    둘 다 상위권일 정도로 참여율이 높다.
                </div>
                </td>
            </tr>
        </table>
    ...
    <div class="Explanation-Div2">
        <table class="Explanation-Table2">
            <tr class="Explanation-Top-tr2">
                <td class="Explanation-td2">상징하는 색</td>
                <td class="Explanation-td3">대표 동물</td>
                <td class="Explanation-td4">창립자</td>
            </tr>
            <tr id="Explanation">
                <td id="Explanation2">
                    <span id="red">붉은색</span>, <span id="gold">황금색</span>
                </td>
                <td id="Explanation3">
                    사자
                </td>
    ...
    <div class="Nickname-Div">
        <img src="/css/domitory/title.png" id="title-backimg">
        <button id="title-text">👑인기글 보기👑</button>
    </div>

    <!-- 👇 글쓰기 👇 -->
    <c:if test="${UserDominame=='그리핀도르'}">
        <div class="Nickname-Div2">
            <img src="/css/domitory/title.png" id="title-backimg2">
            <a href="write">
                <input type="button" value="🖋글쓰기🖋" id="title-text2">
            </a>
        </div>
    </c:if>
<c:if test="${UserDominame=='교장'}">
            <div class="Nickname-Div2">
                <img src="/css/domitory/title.png" id="title-backimg2">
                <a href="write">
                    <input type="button" value="🖋글쓰기🖋" id="title-text2">
    ...
    <c:if test="${UserDominame!='그리핀도르'}">
        <div class="Nickname-Div2">
            <img src="/css/domitory/title.png" id="title-backimg2">
                <a onclick="alert('다른 기숙사에서는 글을 쓸 수 없습니다.')">
                    <input type="button" value="🖋글쓰기🖋" id="title-text2">
                </a>
        </div>
    </c:if>
    ...
    <div class="Main-All-Board" style="float: left;">
        <table class="Main-All-Boardtable">
            <tr>
                <td class="Main-All-BoardName" colspan="4">
                    📝그리핀도르 게시판📝
                </td>
            </tr>
            ...
            <c:forEach var="g" items="${gryList}">
                <tr class="Main-All-Board-Contents">
                    <td class="MAB02_01">
                        <c:set var="TextValue" value="${g.writedate}"/>
                        ${fn:substring(TextValue,0,10)}
                    </td>
                    <td class="MAB02_02" style="text-align: left; cursor:pointer;" onclick="location.href='read?boardnum=${g.boardnum}'">
                        ${g.boardname}
                    </td>
                    <td class="MAB02_03" style="cursor:pointer;"
                    onclick="location.href='userinfo?usernum=${g.usernum}&nick=${g.writer}'">
                        ${g.writer}
                    </td>
                    <td class="MAB02_04">
                        ${g.views}
