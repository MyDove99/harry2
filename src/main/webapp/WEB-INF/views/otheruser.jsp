...
<head>
    ...
    <title>${showInfo.nick}님의 정보</title>
</head>
<body>
<!-- 👇 상단바 👇 -->
        ...
        <table class="Main-All-Boardtable">
            ...
            <c:forEach var="p" items="${postList}">
                <tr class="Main-All-Board-Contents">
                     ...
                     <td id="MAB01_02" style="cursor:pointer;"
                     onclick="location.href='read?boardnum=${p.boardnum}'">
                        <b>${p.boardname}</b>
                     </td>
                     <td id="MAB01_03">
                        <b>${p.writer}</b>
                     ...
                     <td id="MAB01_04">
                        <b><c:set var="TextValue" value="${p.writedate}"/>
                           ${fn:substring(TextValue,0,10)}</b>
                     </td>
                     <td id="MAB01_05">
                        <b>${p.views}</b>
                     </td>
            ...
            <table class="Main-All-Boardtable">
                ...
                <c:forEach var="r" items="${replyList}">
                    <tr class="Main-All-Board-Contents">
                         ...
                         <td id="MAB01_02"style="cursor:pointer;"
                         onclick="location.href='read?boardnum=${r.boardnum}'">
                            <b>${r.boardname}</b>
                         </td>
                         <td id="MAB01_03">
                            <b>${r.writer}</b>
                         ...
                         <td id="MAB01_04">
                            <b><c:set var="TextValue" value="${r.writedate}"/>
                               ${fn:substring(TextValue,0,10)}</b>
                         </td>
                         <td id="MAB01_05">
                            <b>${r.views}</b>
