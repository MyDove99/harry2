...
.on('click','#actioncheck',function(){ //1번 버튼
    if($("#btn1").val()=="start2"){ //게임입장
        ...
        $("#gamehome2").empty();
        $("#enemyimg").attr("src","/css/textrpg/owl.png");
        $("#ename").text("적 이름");
        $.game();
...
$.enemy1=function(){ //적 정보
    ...
    if(random<3){
        ename="박쥐",ehp=29+plv,emhp=29+plv,ead=2+plv,emad=5+plv,eimg="/css/textrpg/bat.png",eexp=19+plv;
    }else if(random<7){
        ename="스켈레톤",ehp=39+plv,emhp=39+plv,ead=1+plv,emad=3+plv,eimg="/css/textrpg/skeleton.png",eexp=19+plv;
    }else if(random<10){
        ename="거미",ehp=19+plv,emhp=19+plv,ead=4+plv,emad=7+plv,eimg="/css/textrpg/spider.png",eexp=19+plv;
    }else if(random<13){
        ename="고블린",ehp=24+plv,emhp=24+plv,ead=3+plv,emad=6+plv,eimg="/css/textrpg/goblin.png",eexp=19+plv;
    }else{
        ename="좀비",ehp=34+plv,emhp=34+plv,ead=3+plv,emad=3+plv,eimg="/css/textrpg/zombie.png",eexp=19+plv;
    }
...
$.event1=function(){ //이벤트
    ...
    if(event<20){
        ...
        $("#enemyimg").attr("src","/css/textrpg/unicon.png");
        $("#ename").text("유니콘");
        eexp=pmexp-pexp;
        $.plevel();
    }
...
$.boss=function(){ //보스
    bossOn=true;
    if(bossorder==1){
        ename="아크로만툴라",ehp=80,emhp=80,ead=8,emad=12,eimg="/css/textrpg/bspider.png",eexp=50;
        $("#gamehome2").append("<li>"+ename+"를 만났습니다.</li>");
        $("#enemyhp").text(ehp+"/"+emhp);
        $("#enemyad").text(ead+"~"+emad);
        $("#enemyimg").attr("src",eimg);
        $("#enemy").append("<tr><td>"+epell1.name+"</td><td>"+epell1.damage+"</td></tr>");
        $("#gamecenter").css("background-image","url('/css/textrpg/bg1.png')");
        ...
        ename="늑대인간",ehp=120,emhp=120,ead=16,emad=20,eimg="/css/textrpg/wearwolf.png",eexp=100;
        $("#gamehome2").append("<li>"+ename+"를 만났습니다.</li>");
        $("#enemyhp").text(ehp+"/"+emhp);
        $("#enemyad").text(ead+"~"+emad);
        $("#enemyimg").attr("src",eimg);
        $("#enemy").append("<tr><td>"+epell5.name+"</td><td>"+epell5.damage+"</td></tr>");
        $("#gamecenter").css("background-image","url('/css/textrpg/bg3.png')");
        $("#gamecenter").css("background-repeat","no-repeat;");
        $("#gamecenter").css("background-size","cover;");
        $("#gamecenter").css("background-position","center;");
        bossorder=bossorder+1;
        ...
        ename="그리폰",ehp=200,emhp=200,ead=17,emad=22,eimg="/css/textrpg/gri.png",eexp=150;
        $("#gamehome2").append("<li>"+ename+"를 만났습니다.</li>");
        $("#enemyhp").text(ehp+"/"+emhp);
        $("#enemyad").text(ead+"~"+emad);
        $("#enemyimg").attr("src",eimg);
        $("#enemy").append("<tr><td>"+epell2.name+"</td><td>"+epell2.damage+"</td></tr>");
        $("#gamecenter").css("background-image","url('/css/textrpg/gribg.jpg')");
        $("#gamecenter").css("background-repeat","no-repeat;");
        $("#gamecenter").css("background-size","cover;");
        $("#gamecenter").css("background-position","center;");
        bossorder=bossorder+1;
        ...
        ename="켄타우로스",ehp=290,emhp=290,ead=28,emad=36,eimg="/css/textrpg/centa.png",eexp=200;
        $("#gamehome2").append("<li>"+ename+"를 만났습니다.</li>");
        $("#enemyhp").text(ehp+"/"+emhp);
        $("#enemyad").text(ead+"~"+emad);
        $("#enemyimg").attr("src",eimg);
        $("#gamecenter").css("background-image","url('/css/textrpg/centabg.jpg')");
        $("#gamecenter").css("background-repeat","no-repeat;");
        $("#gamecenter").css("background-size","cover;");
        $("#gamecenter").css("background-position","center;");
        bossorder=bossorder+1;
        ...
        ename="드래곤",ehp=360,emhp=360,ead=32,emad=36,eimg="/css/textrpg/dragon.png",eexp=250;
        $("#gamehome2").append("<li>"+ename+"를 만났습니다.</li>");
        $("#enemyhp").text(ehp+"/"+emhp);
        $("#enemyad").text(ead+"~"+emad);
        $("#enemyimg").attr("src",eimg);
        $("#enemy").append("<tr><td>"+epell3.name+"</td><td>"+epell3.damage+"</td></tr>");
        $("#gamecenter").css("background-image","url('/css/textrpg/bg4.png')")
        $("#gamecenter").css("background-repeat","no-repeat;");
        $("#gamecenter").css("background-size","cover;");
        $("#gamecenter").css("background-position","center;");
        bossorder=bossorder+1;
        ...
        ename="볼드모트",ehp=480,emhp=480,ead=40,emad=40,eimg="/css/textrpg/voldmort.png",eexp=300;
        $("#gamehome2").append("<li>"+ename+"를 만났습니다.</li>");
        $("#enemyhp").text(ehp+"/"+emhp);
        $("#enemyad").text(ead+"~"+emad);
        $("#enemyimg").attr("src",eimg);
...
$.dementor=function(){ //디멘터
    ename="디멘터",ehp=59+plv,emhp=59+plv,ead=5+plv,emad=10+plv,eimg="/css/textrpg/dementor.png",eexp=34+plv;
    $("#gamehome2").append("<li>"+ename+"를 만났습니다.</li>");
    $("#enemyhp").text(ehp+"/"+emhp);
    $("#enemyad").text(ead+"~"+emad);
    $("#enemyimg").attr("src",eimg);
    $("#ename").text(ename);
    $("#gamecenter").css("background-image","url('/css/textrpg/bg2.png')");
    $("#gamecenter").css({"background-repeat":"no-repeat;"})
    $("#gamecenter").css({"background-size":"cover;"})
...
$.gameend=function(){
        ...
        var score = pscore;
        var boss = kboss;
        var dominum = $("#dominum").val();
    	$.ajax({
    	    url:"/endtextrpg",
    	    type :'POST',
    	    data: {"nick":nick,"stage":stage,"score":score,"boss":boss,"dominum":dominum}
